...
import com.example.hotelplayaparadise_appmovil.databinding.ActivityDrawerMenuBinding
...
class Drawer_Menu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.consulta1
            ), drawerLayout
        )
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.drawer__menu, menu)
        return true
    }
